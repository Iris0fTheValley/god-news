...
_TRANSITIONS = MappingProxyType(
    {
        StoryStatus.FETCHED: frozenset({StoryStatus.TRANSLATED}),
        StoryStatus.TRANSLATED: frozenset({StoryStatus.PENDING_FIRST_REVIEW}),
        StoryStatus.PENDING_FIRST_REVIEW: frozenset({StoryStatus.PROCESSING_SCRIPT}),
        StoryStatus.PROCESSING_SCRIPT: frozenset({StoryStatus.SCRIPT_READY}),
        StoryStatus.SCRIPT_READY: frozenset({StoryStatus.PENDING_SECOND_REVIEW}),
        StoryStatus.PENDING_SECOND_REVIEW: frozenset({StoryStatus.DONE}),
